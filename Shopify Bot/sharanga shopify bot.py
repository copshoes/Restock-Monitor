...
''' ------------------------------ SETTINGS ------------------------------ '''
# Global settings
base_url = "https://www.cybersole.io"  # Don't add a / at the end

# Search settings
keywords = ["cybersole", "AIO"]  # Seperate keywords with a comma
size = "11"
...
postal_code = "48306"
phone = "phone"
card_number = "card"  # No spaces
cardholder = "name"
exp_m = "month"  # 2 digits
exp_y = "year"  # 4 digits
cvv = "number"  # 3 digits
